...
public class Console {
	...
	// Number) ***
	// *****************************************************************************
	public static int getInt(Scanner sc, String prompt, int numDigits) {
		int i = 0;
		boolean isValid = false;
		while (!isValid) {
			System.out.print(prompt);
	...
	// *********************************************************************
	public static String getString(Scanner sc, String prompt, int min, int max) {
		String string = "";
		boolean isValid = false;
		while (!isValid) {
			System.out.print(prompt);
	...
	// ********************************************************************
	public static String getString(Scanner sc, String prompt, int numChars) {
		String string = "";
		boolean isValid = false;
		while (!isValid) {
			System.out.print(prompt);
	...
	// ***************************************************************************
	public static long getLong(Scanner sc, String prompt, int numDigits) {
		long i = 0;
		boolean isValid = false;
		while (!isValid) {
			System.out.print(prompt);
	...
	// ****************************************
	public static String getYNFlag(Scanner sc, String prompt) {
		String flag = "";
		boolean isValid = false;
		while (!isValid) {
			System.out.print(prompt);
	...
	// ***************************************************************
	public static Boolean getYNBoolean(Scanner sc, String prompt) {
		String flag = "";
		Boolean returnFlag;
		boolean isValid = false;
		while (!isValid) {
	...
	// *************************************************************
	public static String getPassword(Scanner sc, String prompt, String userName, int min, int max) {
		String password = "";
